...
public class AdaptadorUsuarioBuscada extends ArrayAdapter<User> {
    ...
    public AdaptadorUsuarioBuscada(Context context, ArrayList<User> tutorias, Activity activity) {
